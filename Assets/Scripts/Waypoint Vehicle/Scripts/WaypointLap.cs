...
public class WaypointLap : MonoBehaviour
{
    #region FIELDS
    ...
    {
        [SerializeField]
        public WaypointLap _lap = default;
...
# if UNITY_EDITOR
    ...
    private void DrawGizmos(bool selected)
    {
        ...
        if (WaypointData.Length > 1)
        {
            ...
            CachePositionsAndDistances();
            _length = Lap ? _distances[_distances.Length - 1] : _distances[_distances.Length - 2];
    ...
    private void CreateInternal()
    {
        for (var n = 0; n < WaypointData.Length; n++)
        {
            ...
            {
                nextIndex = Lap ? 0 : WaypointData.Length - 1;
            }
